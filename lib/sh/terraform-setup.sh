...
INFRA_DEPLOYMENT_ENDPOINT=$CONTENT_ROOT/deployments/terraform/$INFRA_DEPLOYMENT_NAME
INFRA_TARGET_ENDPOINT=$CONTENT_ROOT/targets/$INFRA_TARGET_NAME/terraform/$INFRA_DEPLOYMENT_NAME
