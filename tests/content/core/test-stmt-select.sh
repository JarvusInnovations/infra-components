...
test_cmd "test bazs-item-2 = $(opt_keyseq_tolist $bazs_item_keyseq | sed -n 4p)"
test_cmd "test ./bazs-subject-path = $(opt_keyseq_tolist $bazs_item_keyseq | sed -n 5p)"
test_cmd "test bazs-item-3 = $(opt_keyseq_tolist $bazs_item_keyseq | sed -n 6p)"
